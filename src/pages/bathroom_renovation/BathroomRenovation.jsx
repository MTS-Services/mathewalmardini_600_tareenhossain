...
import { Phone, CheckCircle, Image } from "lucide-react";
...
function BathroomRenovation() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Why Bespoke Designs and Construction Section */}
      <section className="py-16 md:py-24 lg:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
          ...
          >
            <motion.h2
              ...
              transition={{ delay: 0.2, duration: 0.6 }}
            >
              Why Bespoke Designs and Construction
            </motion.h2>
          </motion.div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  <CheckCircle className="w-6 h-6 text-[#2D6B7A] flex-shrink-0 mt-1" />
