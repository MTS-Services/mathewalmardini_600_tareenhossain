...
export const BACK_BTN =
  "inline-flex items-center gap-2 rounded-2xl px-2 py-4 text-base font-bold text-[#1a3f4a] transition duration-200 hover:text-[#2D6B7A] hover:-translate-x-0.5 disabled:opacity-50 max-sm:gap-1.5 max-sm:rounded-xl max-sm:px-1.5 max-sm:py-2.5 max-sm:text-sm";

export const PRIMARY_BTN =
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl bg-[#2D6B7A] px-8 py-4 text-base font-bold text-white shadow-[0_12px_30px_rgba(45,107,122,0.35)] transition duration-200 hover:scale-[1.02] hover:bg-[#1e5562] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:scale-100 max-sm:min-h-[2.75rem] max-sm:gap-1.5 max-sm:rounded-xl max-sm:px-4 max-sm:py-2.5 max-sm:text-sm max-sm:shadow-[0_8px_20px_rgba(45,107,122,0.3)]";
