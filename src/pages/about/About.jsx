...
function About() {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-[#2D6B7A] to-[#1e5562] min-h-[50vh] flex items-center justify-center py-16 md:py-24 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <motion.a
                href="tel:0432661176"
                className="text-[#2D6B7A] font-bold text-xl hover:text-[#1e5562] transition-colors inline-block"
