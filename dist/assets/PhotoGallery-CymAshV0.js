import{b as u,r as s,j as e}from"./index-CfmQCJbW.js";import{m as n}from"./proxy-BRGU2UrN.js";const c=[{id:1,src:"https://res.cloudinary.com/dv18awr10/image/upload/v1772780153/20240604_153801__1_qq1mmm.jpg"},{id:2,src:"https://res.cloudinary.com/dv18awr10/image/upload/v1772780182/20250404_123149_buvhoa.jpg"},{id:3,src:"https://res.cloudinary.com/dv18awr10/image/upload/v1772780203/Bath_af1efv.jpg"},{id:4,src:"https://res.cloudinary.com/dv18awr10/image/upload/v1772780223/Craigieburn_5_eye36g.jpg"},{id:5,src:"https://res.cloudinary.com/dv18awr10/image/upload/v1772780242/IMG_9819_zsrcjx.jpg"}],f=()=>{const m=u(),[a,o]=s.useState(1),[p,r]=s.useState(5),[d,h]=s.useState(!1),l=()=>{m("/portfolio")};s.useEffect(()=>{const t=()=>{const i=window.innerWidth;h(i<1024),i>=1024&&i<=1439?r(4):i>=1024&&r(5)};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]);const g=c.slice(0,p);return e.jsxs("div",{className:"bg-white",style:{paddingTop:"4rem",paddingBottom:"4rem"},children:[e.jsx("div",{style:{marginBottom:"3rem",textAlign:"center"},children:e.jsx("h2",{className:"text-black font-bold text-2xl md:text-3xl lg:text-4xl",children:"OUR GALLERY"})}),d&&e.jsxs("div",{style:{width:"100%",paddingLeft:"1rem",paddingRight:"1rem"},children:[e.jsx("style",{children:`
            .photo-gallery-grid {
              display: grid;
